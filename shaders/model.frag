...
// TODO: Temporally. Add camera position to UBO model
const vec3 CAMERA_POSITION = vec3(0.0, 0.0, 0.0);

// TODO: Remove this. When lighs and shadows will be implemented
const vec3 DIRECTION_TO_LIGHT = normalize(vec3(0.0, 3.0, 3.0));
const float AMBIENT = 0.25;

const float PREFILTEREDCUBEMIPLEVELS = 1.0f;
...
void main() {
    ...
    vec3 v = normalize(CAMERA_POSITION - inWorldPos);    // Vector from surface point to camera
    vec3 l = DIRECTION_TO_LIGHT;     // Vector from surface point to light
