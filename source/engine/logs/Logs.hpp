...
namespace re::log {
    ...
    inline void addFile(const std::string& name) {
        LogsManager::instance()->addFile(name.c_str());
    }
...
#endif
        LogsManager::instance()->writeFile(file, spdlog::level::err, message);
    }
    ...
    inline void info(const std::string& message, const std::string& file = DEFAULT_FILE_NAME) {
        ...
        spdlog::info(message);
#endif
        LogsManager::instance()->writeFile(file, spdlog::level::info, message);
    }
    ...
    inline void warn(const std::string& message, const std::string& file = DEFAULT_FILE_NAME) {
        ...
        spdlog::warn(message);
#endif
        LogsManager::instance()->writeFile(file, spdlog::level::warn, message);
    }
...
#endif
        LogsManager::instance()->writeFile(file, spdlog::level::debug, message);
    }
...
#endif
        LogsManager::instance()->writeFile(file, spdlog::level::critical, message);
    }
...
#endif
        LogsManager::instance()->writeFile(file, spdlog::level::trace, message);
    }
