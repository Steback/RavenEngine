...
namespace re {
    ...
    Material::Material(const tinygltf::Model& model, const tinygltf::Material& material) {
        if (material.values.find("baseColorTexture") != material.values.end()) {
            baseColorTexture = AssetsManager::getInstance()->addTexture(model, model.textures[material.pbrMetallicRoughness.baseColorTexture.index]);
        ...
        if (material.values.find("metallicRoughnessTexture") != material.values.end()) {
            metallicRoughnessTexture = AssetsManager::getInstance()->addTexture(model, model.textures[material.pbrMetallicRoughness.metallicRoughnessTexture.index]);
        ...
        if (material.additionalValues.find("normalTexture") != material.additionalValues.end()) {
            normalTexture = AssetsManager::getInstance()->addTexture(model, model.textures[material.normalTexture.index]);
        ...
        if (material.additionalValues.find("emissiveTexture") != material.additionalValues.end()) {
            emissiveTexture = AssetsManager::getInstance()->addTexture(model, model.textures[material.emissiveTexture.index]);
        ...
        if (material.additionalValues.find("occlusionTexture") != material.additionalValues.end()) {
            occlusionTexture = AssetsManager::getInstance()->addTexture(model, model.textures[material.occlusionTexture.index]);
        ...
        if (material.extensions.find("KHR_materials_pbrSpecularGlossiness") != material.extensions.end()) {
            ...
            if (ext->second.Has("specularGlossinessTexture")) {
                ...
                extension.specularGlossinessTexture = AssetsManager::getInstance()->addTexture(model, model.textures[index]);
            ...
            if (ext->second.Has("diffuseTexture")) {
                ...
                extension.diffuseTexture = AssetsManager::getInstance()->getInstance()->addTexture(model, model.textures[index]);
            }
